...
public class SendPhotoEMailOrFTP {

	public static boolean send(Context context, File file, boolean ftp) {
		boolean netOk = true;
				...
				else
				{
					...
					try {
					    ...
					    try {
							...
							Logs.errorLog("SendPhotoEMailOrFTP.send: Error sending e-mail", e);
					    }
			    	} catch (Exception e) {
